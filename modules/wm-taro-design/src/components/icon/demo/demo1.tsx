...
import { Row, Col, Icon } from 'wm-taro-design';
import '@/base-ui/demo-block/index.less';
  ...
  return (
    <>
      <Row>
        ...
        <Col className='col' span='6'>
          <Icon name='https://b.yzcdn.cn/vant/icon-demo-1126.png' size='32px' className='icon'></Icon>
        </Col>
      </Row>
      <Row>
      ...
      <Row>
        ...
        <Col className='col' span='6'>
          <Icon color='#1989fa' name='chat-o' size='32px' className='icon'></Icon>
        </Col>
        <Col className='col' span='6'>
          <Icon color='#07c160' name='chat-o' size='32px' className='icon'></Icon>
        </Col>
      </Row>
      <Row>
