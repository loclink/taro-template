...
export function LongSpan(props: IProps) {
  ...
  return (
    <View className="wm-calendar-longspan">
      <View className="wm-calendar__header-title">切换年月</View>

      <View className="wm-calendar-longspan-title">年份选择</View>
      <View className="wm-calendar-longspan-box">
        {data.map((item, index) => (
          <Button
            ...
            className="wm-calendar-longspan-item"
            onClick={() => {
      ...
      <View className="wm-calendar-longspan-title">月选择</View>
      <View className="wm-calendar-longspan-box">
        {monthData.map((item) => (
          <Button
