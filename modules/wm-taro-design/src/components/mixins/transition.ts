...
const getClassNames = (name: string) => ({
  enter: `wm-${name}-enter wm-${name}-enter-active enter-class enter-active-class`,
  'enter-to': `wm-${name}-enter-to wm-${name}-enter-active enter-to-class enter-active-class`,
  leave: `wm-${name}-leave van-${name}-leave-active leave-class leave-active-class`,
  'leave-to': `wm-${name}-leave-to wm-${name}-leave-active leave-to-class leave-active-class`
});
