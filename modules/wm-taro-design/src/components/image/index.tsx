...
import './index.less';
type TaroImageMode = 'center' | 'scaleToFill' | 'aspectFill' | 'aspectFit' | 'widthFix' | 'heightFix';
    ...
    >
      {!error && (
        <TaroImage
          ...
          lazyLoad={lazyLoad}
          className='image-class wm-image__img'
      ...
      {loading && showLoading && (
        <View className='loading-class wm-image__loading'>
          {renderLoading || <VanIcon name='photo' className='wm-image__loading-icon'></VanIcon>}
        </View>
      )}
      {error && showError && (
        <View className='error-class wm-image__error'>
          {renderError || <VanIcon name='photo-fail' className='wm-image__error-icon'></VanIcon>}
        </View>
      )}
    </View>
  );
