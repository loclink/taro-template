...
export function WaterfallFlowItem<TRecord extends BaseRecord>({
  ...
  useSubscribeElementSize(`#${contentId}`, `#${compareId}`, `#${id}`, onItemResize, calculationDelay, [item]);
  ...
  return (
    <View className='wm-waterfall-flow-item' style={style} id={id}>
      <View className='wm-compare-area' id={compareId}>
        <View className='wm-waterfall-flow-item-content' id={contentId} style={contentStyle}>
          {child}
        </View>
      </View>
    </View>
